...
class DestListAdapter(c: Context, list: ArrayList<DestList>, onClick: OnClickInterface) : RecyclerView.Adapter<DestListAdapter.ViewHolder>() {
...
//            Toast.makeText(mContext, mList[position].destDesc, Toast.LENGTH_LONG).show()
            ...
            holder.layer!!.setBackgroundResource(R.drawable.lowgreen_round_background)
            holder.txt.setTextColor(Color.parseColor("#1bc371"))
            holder.txt_sub.setTextColor(Color.parseColor("#1bc371"))
        }
