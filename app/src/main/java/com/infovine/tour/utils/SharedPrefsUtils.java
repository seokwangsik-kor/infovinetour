...
/**
 * Created by chlee on 2018-12-10.
 */
...
//        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static String getStringPreference(Context context, String key, String base) {
        String value = null;
//        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if(preferences == null){
            preferences = new SecurePreferences(context);
        ...
        if (preferences != null) {
            value = preferences.getString(key, base);
        }
        return value;
    }
...
//    public static boolean clearPreference(Context context, String key, boolean value) {
////        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
//        if(preferences == null){
//            preferences = new SecurePreferences(context);
//        }
